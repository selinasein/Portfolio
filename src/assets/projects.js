export const projects = [
  {
    ...
    skills: "JavaScript, Next, Tailwind CSS, Framer-motion",
  },
  {
    id: 2,
    title: "Bucketed",
    description: "Social networking app for people with bucket lists",
    image: "/images/bucketed-thumbnail.png",
    explanation:
    ...
    skills: "JavaScript, Prisma, Passport, Multer, Cloudinary, EJS, Jest",
  },
  {
    id: 3,
    title: "Nibble Nook",
    description: "AI Recipe Generator",
    image: "/images/nibblenook.png",
    explanation:
    ...
    skills: "Axios, OpenAI API, Docker, React, Vite, TypeScript, TailwindCSS",
  },
  {
    id: 4,
    title: "Cocoon",
    description: "AI powered career development app",
    image: "/images/cocoon_thumbnail.png",
    explanation:
